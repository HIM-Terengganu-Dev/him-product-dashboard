...
function ProductGMVUploadContent() {
    ...
    // Extract date from filename: "Product campaign data (2025-11-21 - 2025-11-21) (1).xlsx"
    const extractDateFromFilename = (filename: string): string | null => {
        // Pattern: "Product campaign data (YYYY-MM-DD - YYYY-MM-DD) (1).xlsx"
    ...
    const handleUpload = async () => {
        ...
        const uploadPromises = selectedFiles.map(async (fileWithDate, index) => {
            ...
            try {
                ...
                const response = await fetch('/api/tiktok/product-gmv/upload', {
                    method: 'POST',
                    body: formData,
                });
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold bg-gradient-to-r from-pink-600 to-red-600 bg-clip-text text-transparent">
                                Upload Product GMV Data
                            </h1>
                            <p className="text-sm text-gray-600 mt-1">Import TikTok Product GMV performance data</p>
                        </div>
                        <Link
            ...
            <div className="max-w-5xl mx-auto px-6 py-8 space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                            ...
                            <ul className="text-sm text-blue-800 space-y-1 list-disc list-inside">
                                ...
                                <li>Date will be auto-detected from each filename (format: "Product campaign data (YYYY-MM-DD - YYYY-MM-DD) (1).xlsx")</li>
                                ...
                                <li>Campaign names are used directly as group names (no bracket detection needed)</li>
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-xs text-gray-500 mt-1">
                            {searchParams?.get('date') 
                                ...
                                : 'Date will be auto-detected from each filename (format: "Product campaign data (YYYY-MM-DD - YYYY-MM-DD) (1).xlsx"). If filename has no date, the selected date above will be used.'
                            }
                        </p>
                    </div>
                            ...
                            {selectedFiles.length > 0 ? (
                                ...
                                <>
                                    ...
                                    <label className="inline-block">
                                        <span className="px-6 py-3 bg-gradient-to-r from-pink-600 to-red-600 text-white font-semibold rounded-lg hover:from-pink-700 hover:to-red-700 transition-all cursor-pointer shadow-md">
                                            Browse Files
                                        </span>
                                        <input
                                            type="file"
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
                    ...
                    <p className="text-xs text-gray-500 mt-3">
                        <strong>Campaign Group:</strong> Campaign names are used directly as group names. No bracket detection is performed. 
                        If an Excel column for "Campaign Group" exists, it will be used; otherwise, the campaign name itself becomes the group name.
                    </p>
                </div>
            </div>
        </div>
...
export default function ProductGMVUploadPage() {
    return (
        <Suspense fallback={
