...
export default function ProductGMVDashboard() {
    ...
    useEffect(() => {
        const fetchLatestDate = async () => {
            try {
                const response = await fetch('/api/tiktok/product-gmv/latest-date');
                if (response.ok) {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            try {
                ...
                let metricsUrl = `/api/tiktok/product-gmv/metrics?date=${selectedDate}&comparisonPeriod=${comparisonPeriod}`;
                if (comparisonPeriod === 'customDate' && customComparisonDate) {
                ...
                const [metricsRes, groupsRes] = await Promise.all([
                    fetch(metricsUrl),
                    fetch(`/api/tiktok/product-gmv/groups?date=${selectedDate}`)
                ]);
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
                        <div className="flex-1 min-w-0">
                            <h1 className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-pink-600 to-red-600 bg-clip-text text-transparent truncate">
                                TikTok Product GMV Performance
                            </h1>
                            <p className="text-xs sm:text-sm text-gray-600 mt-1 hidden sm:block">Product campaign analytics and metrics</p>
                        </div>
                        <div className="flex items-center gap-2 sm:gap-3 w-full sm:w-auto">
                            ...
                            <div className="hidden md:flex items-center gap-3">
                                ...
                                <Link
                                    ...
                                    className="px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-white bg-gradient-to-r from-pink-600 to-red-600 rounded-lg hover:from-pink-700 hover:to-red-700 transition-colors shadow-md"
                                >
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-3 w-full sm:w-auto">
                                ...
                                <div className="flex items-center gap-2 w-full sm:w-auto">
                                    <input
                                        ...
                                        className="flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                                    />
                                    {selectedDate && (
                                        <button
                                            onClick={async () => {
                                            ...
                                            className="px-2 sm:px-3 py-2 text-xs font-medium text-pink-600 bg-pink-50 rounded-lg hover:bg-pink-100 transition-colors whitespace-nowrap"
                                        >
                                            📅 Latest
                                        </button>
                                    )}
                                ...
                                {comparisonPeriod === 'customDate' && (
                                    <div className="flex items-center gap-2 w-full sm:w-auto">
                                        <input
                                            ...
                                            className="px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-xs sm:text-sm focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                    ...
                    <>
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            <h2 className="text-lg sm:text-xl font-bold text-gray-800 flex items-center gap-2">
                                <span className="w-1.5 sm:w-2 h-6 sm:h-8 bg-pink-600 rounded-full"></span>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
                                ...
                                {/* Summary Card */}
                                <div className="bg-gradient-to-br from-pink-500 to-red-600 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 text-white">
                        ...
                        <div className="space-y-3 sm:space-y-4">
                            <h2 className="text-lg sm:text-xl font-bold text-gray-800 flex items-center gap-2">
                                <span className="w-1.5 sm:w-2 h-6 sm:h-8 bg-red-600 rounded-full"></span>
