    ...
    return (
        <div className="min-h-full flex items-center justify-center p-3 sm:p-6">
            <div className="max-w-2xl w-full bg-white rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 shadow-2xl border border-gray-100">
                ...
                {/* Portal Card */}
                <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-xl sm:rounded-2xl p-6 sm:p-8 mb-6 border-2 border-indigo-100">
                    <div className="flex items-start gap-3 sm:gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">HIM Product Sales Portal</h3>
                            ...
                            <Link
                                href="/sales-portal"
                                className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-bold rounded-xl hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-1 text-sm sm:text-base w-full sm:w-auto justify-center"
                            >
