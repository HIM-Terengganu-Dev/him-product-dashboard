...
export const LogoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5-10-5-10 5zM12 12.894L6.468 10 12 7.106 17.532 10 12 12.894z" />
    </svg>
);
...
export const CurrencyDollarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.553-.44 1.28-.659 2.003-.659.725 0 1.45.22 2.003.659l.879.659m0-2.25h.008v.008h-.008v-.008zm0 14.25h.008v.008h-.008v-.008z" />
  </svg>
);
...
export const PercentIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 7.5h-.75A2.25 2.25 0 004.5 9.75v.75c0 .414.336.75.75.75h.75v-.75a2.25 2.25 0 012.25-2.25h.75v-.75zm-3.75 9h.75a2.25 2.25 0 002.25-2.25v-.75c0-.414-.336-.75-.75-.75h-.75v.75a2.25 2.25 0 01-2.25 2.25h-.75v.75zM21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5.625-4.5a.75.75 0 10-1.5 0v9a.75.75 0 101.5 0v-9z" />
  </svg>
);
...
export const GoogleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg {...props} viewBox="0 0 48 48">
    ...
    <path fill="#1976D2" d="M43.611 20.083H42V20H24v8h11.303c-.792 2.237-2.231 4.166-4.087 5.571l6.19 5.238C42.012 35.849 44 30.138 44 24c0-1.341-.138-2.65-.389-3.917z"></path>
  </svg>
);
